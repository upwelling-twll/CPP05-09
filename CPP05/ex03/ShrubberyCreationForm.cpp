...
ShrubberyCreationForm::~ShrubberyCreationForm( void )
{
	std::cout << "ShrubberyCreationForm destructor is called for " << this->getName() \
	<< std::endl;
}
...
{
	std::cout << "ShrubberyCreationForm copy assignment is called for ShrubberyCreationForm " \
	<< std::endl;
	if (this != &src)
	{
		AForm::operator=(src);
